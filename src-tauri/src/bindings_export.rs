...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            commands::local::feed::app__startup_online_backfill_insert,
            commands::local::feed::app__profile_feed_reconcile,
            ...
            commands::local::mutual_graph::app__manual_relations_list,
            commands::local::mutual_graph::app__manual_relations_for_user,
            commands::local::mutual_graph::app__manual_relation_add,
            commands::local::mutual_graph::app__manual_relation_remove,
            ...
            commands::local::tracked_nonfriends::app__tracked_nonfriends_list,
            commands::local::tracked_nonfriends::app__tracked_nonfriends_add,
            commands::local::tracked_nonfriends::app__tracked_nonfriends_remove,
            commands::local::tracked_nonfriends::app__tracked_nonfriends_is_tracked,
            ...
            commands::host::window::app__get_sidebar_auto_hide,
            commands::host::tray_shortcut::app__get_tray_shortcut,
            commands::host::tray_shortcut::app__set_tray_shortcut,
            commands::host::tray_shortcut::app__check_tray_shortcut,
            commands::host::tray_shortcut::app__set_tray_shortcut_recording,
            commands::host::tray_shortcut::app__take_tray_shortcut_startup_failure,
            commands::host::window::app__set_sidebar_auto_hide,
